-- Simple capstone-friendly MySQL schema for Logistics requests reviewed by Finance
...
--     ADD CONSTRAINT fk_logistics_requested_by
--     FOREIGN KEY (requested_by) REFERENCES employees(id);
--
-- ALTER TABLE logistics_requests
--     ADD CONSTRAINT fk_logistics_department
